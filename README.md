...
`wtl` packages Windows Template Library 9.1.5321 as a CMake header-only
dependency.
...
```cmake
find_package(wtl 9.1.5321 EXACT CONFIG REQUIRED)
```
...
```cmake
find_package(wtl 9.1.5321 CONFIG REQUIRED)
